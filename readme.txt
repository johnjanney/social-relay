...
= 0.3.1 =
* Fixed: the three buttons in the post edit screen box ("Cancel scheduled post", "Repost now", "Post to X now") did nothing in the block editor. They work in both editors now, and the confirmations say that unsaved edits are not included.
