...
- None of the three meta box buttons did anything in the block editor. "Cancel
  ...
  the day after 0.3.0 shipped; spec amendment 3. Because a link bypasses the
  editor's save, both paid confirmations now say that unsaved edits are not
  included, and the repost description and `INSTRUCTIONS.md` say to save first.
  (Review finding on PR #9: the documented fix-a-typo-then-repost workflow would
  otherwise post the stale title.)
