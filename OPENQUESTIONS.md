...
- **OQ-15** — **resolved 2026-09-06.** `/2/tweets` created a post on X in production, owner-reported. On 2026-09-07 the owner added that the featured image, hashtags and link all went out, both automatically on publish and by "Post to X now". Listed here because the section below still describes the state at the gate.
